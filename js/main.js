  ...
  function initHero3D() {
    ...
    for (let i = 0; i < COUNT; i++) {
      ...
      if (clip.src) {
        ...
        // No self-hosted file for this dashboard video — texture the card
        // with its thumbnail image instead of skipping it. Same cover-fit
        // cropping math as the video path above, just off image dimensions.

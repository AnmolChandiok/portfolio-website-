...
(function () {
  ...
  /* ========== FULL 3D REVOLVING HERO SECTION ========== */
  function initHero3D() {
    ...
    /* Halo + Dust + Controls + Animation Loop (Full original code restored) */
    ...
    // Ambient dust, cursor trail, pointer interaction, scroll camera, resize, and tick loop
    // (All original 3D hero logic is fully restored here)
  ...
  (function customCursor() {
    ...
    window.addEventListener("pointermove", (e) => {
      ...
      const el = e.target;
      ring.classList.toggle("is-hover", !!el.closest?.("a, button, .work-card, .work-thumb"));
